    ...
    'flows_list': [
        {'app': 'TCP',
         ...
         'since': {'day': '02',
                   ...
                   'secs': '50',
                   'year': '2014'},
         'source ip': IPv4Address(u'10.3.2.54'),
         'source port': 40097,
         'type': 'PI'},
        {'app': 'TCP',
         ...
         'since': {'day': '02',
                   ...
                   'secs': '09',
                   'year': '2014'},
         'source ip': IPv4Address(u'10.3.2.23'),
         'source port': 52618,
         'type': 'PI'},
        {'app': 'TCP',
         ...
         'since': {'day': '02',
                   ...
                   'secs': '04',
                   'year': '2014'},
         'source ip': IPv4Address(u'10.18.32.131'),
         'source port': 49671,
         'type': 'PI'},
        {'app': 'TCP',
         ...
         'since': {'day': '02',
                   ...
                   'secs': '04',
                   'year': '2014'},
         'source ip': IPv4Address(u'10.3.2.24'),
         'source port': 42797,
         'type': 'PI'},
        {'app': 'TCP',
         ...
         'since': {'day': '02',
                   ...
                   'secs': '06',
                   'year': '2014'},
         'source ip': IPv4Address(u'10.3.1.87'),
         'source port': 13729,
         'type': 'PI'},
    ],
    'flows_summary': {
        ...
        'total': {u'all': 11, u'v4': 40, u'v6': 70}}
}
